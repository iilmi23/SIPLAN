...
import { ArrowPathIcon, EyeIcon, EyeSlashIcon, PencilSquareIcon } from "@heroicons/react/24/outline";
...
function PermissionPanel({ catalog, selected, onToggle, onReset, errors }) {
    ...
    return (
        <div>
            <div className="flex items-center justify-between gap-3 mb-3">
                ...
                <button type="button" onClick={onReset} className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#1D6F42] hover:text-[#185c38]">
...
export default function Edit({ user, permissionCatalog = {}, roleDefaults = {} }) {
    ...
    return (
        <AdminLayout title="Edit User">
            ...
            <div className="min-h-screen bg-gray-50/40 pt-2 pb-8 px-5 md:px-8 font-sans">
                <Breadcrumb items={[{ label: "System" }, { label: "Users", href: route("users.index") }, { label: "Edit" }]} />
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-4xl">
                    <div className="p-6 pb-4 border-b border-gray-100">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">Edit User</h1>
                                <p className="text-sm text-gray-500 mt-1">Update account data, role, and sidebar access.</p>
                            </div>
                        </div>
                    </div>
